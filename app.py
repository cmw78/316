...
def edit_student():
    ...
    if form.validate_on_submit():
        try:
            ...
            for courseid in form.get_bookbag():
                #print form.get_bookbag().courseid
                models.Student.info(studentid, courseid, form.get_bookbag(), form.get_taking(), form.get_taken())
            for courseid in form.get_taking():
                #print form.get_bookbag().courseid
                models.Student.info(studentid, courseid, form.get_bookbag(), form.get_taking(), form.get_taken())
            for courseid in form.get_taken():
                #print form.get_bookbag().courseid
                models.Student.info(studentid, courseid, form.get_bookbag(), form.get_taking(), form.get_taken())
